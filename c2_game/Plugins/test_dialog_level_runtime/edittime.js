...
AddAction(0, af_none, "Run test dialog", "General", "Run test dialog {0}",
...
AddExpression(2, ef_return_string, "Get question situation", "Get question situation",
    "getQuestionSituation", "Get question situation");
