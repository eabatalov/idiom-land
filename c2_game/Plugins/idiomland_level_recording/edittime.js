...
{
	return {
		"name":			"Idiomland level recording",// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"IdiomlandLevelRecordingPlugin",		// this is used to identify this plugin and is saved to the project; never change it
		"version":		"0.1",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"Interface to idiomalnd level recording fascilities",
