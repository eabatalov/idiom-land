...
cr.plugins_.IdiomlandLevelRecordingPlugin = function(runtime)
{
...
(function ()
{
	var pluginProto = cr.plugins_.IdiomlandLevelRecordingPlugin.prototype;
    ...
    instanceProto.onLevelChanged = function(questLevelRuntime) {
        if (this.levelGameplayRecorder)
            this.levelGameplayRecorder.delete();
        this.levelGameplayRecorder =
            new IdiomLandLevelGameplayRecordsCollector(questLevelRuntime);
