...
cr.plugins_.PlatformerLevelRecordingPlugin = function(runtime)
{
...
(function ()
{
	var pluginProto = cr.plugins_.PlatformerLevelRecordingPlugin.prototype;
    ...
    instanceProto.onLevelChanged = function(questLevelRuntime) {
        ...
        this.levelGameplayRecorder =
            new PlatformerLevelGameplayRecorder(this.levelGameplayHistory);
	...
	Acts.prototype.recCoinCollected = function(coinUID) {
