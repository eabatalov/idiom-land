...
cr.plugins_.PlatformerLevelPlaybackPlugin = function(runtime)
{
...
(function ()
{
	var pluginProto = cr.plugins_.PlatformerLevelPlaybackPlugin.prototype;
    ...
    instanceProto.onLevelChanged = function(questLevelRuntime) {
        ...
        this.levelReplayPlayerController =
            new PlatformerLevelReplayPlayerController(
                    new PlatformerLevelReplayPlayer(),
    ...
    instanceProto.onRecPending = function(rec) {
        this.runtime.trigger(pluginProto.cnds.recordIsPending, this);
    };
    ...
    Cnds.prototype.recordIsPending = function() {
        return true;
    };
    ...
    Exps.prototype.getType = function(ret) {
        ...
        switch(rec.getRecordType()) {
            case PlatformerCoinCollectedRecord.type:
                ret.set_string("COIN_COLLECTED");
            break;
        }
    };

    Exps.prototype.getUID = function(ret) {
        var rec = this.levelReplayPlayerController.getPendingRecord();
        switch(rec.getRecordType()) {
            case PlatformerCoinCollectedRecord.type:
                ret.set_int(rec.getCoinUID());
                return;
        }
